...
use_ok('Samizdat::Model::Website');
use_ok('Samizdat::Controller::Website');
use_ok('Samizdat::Plugin::Website');
...
ok(-d File::Spec->catdir($dist_lib, 'templates', 'website'), 'website templates ship with the dist');
